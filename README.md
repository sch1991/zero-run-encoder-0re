...
<br><br>
### - 분석
- 샘플 파일 압축 결과 ZIP 포맷의 압축 알고리즘은 13\~74% 수준의 압축률을 보인 반면, 본 프로젝트의 압축 알고리즘은 2\~8% 압축률에 그쳤고 일부 파일에서 마이너스 압축률을 기록하였다.
- 본 프로젝트의 압축 알고리즘은 정보 엔트로피가 낮은 샘플 파일을 입력했음에도 불구하고 효과적으로 압축하지 못하였기에 실용성이 부족한 것으로 판단된다.
<br><br><br>
